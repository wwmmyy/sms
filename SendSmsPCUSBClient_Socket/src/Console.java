...
//
///**
// * 详细说明：安卓与PC之间的USB通信，client为java程序，用eclipse在PC端运行，service为安卓程序，
// * 导入eclipse后在手机端运行，建立连接后，PC端输入数据可与手机通信
// * -Android between PC and USB communication, client for Java programs, 
// * with eclipse in PC operation, service for android application, import after the eclipse 
// * in the mobile terminal operation, after the connection is established, 
// * PC input data and mobile communication
// * @author john
// *
// */
...
//                                    + strFormsocket);  
//                    byte[] filebytes = FileHelper.readFile("C://more.png");  
...
//            
//            System.out.println("numReadedBytes = " + numReadedBytes);
//            
